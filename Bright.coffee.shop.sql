...
SELECT *
FROM projectcoffee.bright.coffee_sales
LIMIT 10;
...
-------------------------------------------------------------------------------------------
--To check types of products
SELECT DISTINCT product_category
FROM projectcoffee.bright.coffee_sales;

-------------------------------------------------------------------------------------------
--To check when was the shop opened
SELECT MIN(transaction_date) AS first_operating_date
FROM projectcoffee.bright.coffee_sales;

-------------------------------------------------------------------------------------------
--To check the last oprating date
SELECT MAX(transaction_date) AS last_operating_date
FROM projectcoffee.bright.coffee_sales;
-------------------------------------------------------------------------------------------
--To check at what time does the shop open
SELECT MIN(transaction_time) AS opening_hour
FROM projectcoffee.bright.coffee_sales;
-------------------------------------------------------------------------------------------
--To check at what time does the shop close
...
SELECT transaction_date,
       ...
       CASE
        ...
        WHEN transaction_time >= '17:00:00' THEN 'Night'
       END AS time_bucket,
